...
<head>
    ...
    <link rel="stylesheet" href="/public/plugins/layui-v2.5.4/css/layui.css" media="all">
    <!--[if lt IE 9]>
            ...
            <form class="layui-form" action="">
                ...
                <!--<div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="/public/images/captcha.jpg">
                    </div>
                </div>-->
                <div class="layui-form-item">
...
<script src="/public/plugins/jquery-3.4.1/jquery-3.4.1.min.js" charset="utf-8"></script>
<script src="/public/plugins/layui-v2.5.4/layui.js" charset="utf-8"></script>
<script src="/public/plugins/jq-module/jquery.particleground.min.js" charset="utf-8"></script>
<script>
